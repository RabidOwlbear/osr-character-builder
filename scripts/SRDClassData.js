...
Hooks.once('OSECB Registered', async () => {
  ...
  OSECB.data.SRDClassData = {
    cleric: {
      ...
      spellType: 'cleric',
      spellPackName: `${OSECB.moduleName}.OSE-SRD-spells`,
    ...
    <b>Languages</b>: Alignment, Common<br>`,
      ...
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.MxTAGtazZxJfvF7M]{Cleric}<br>`,
      maxLvl: 14,
      nameType: 'human'
    },
    dwarf: {
    ...
    Dwarvish, Gnomish, Goblin, Kobold<br>`,
      ...
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.8FaYQ5BwGMxlWJA7]{Dwarf}<br>`,
      maxLvl: 12,
      nameType: 'dwarf'
    },
    elf: {
    ...
    <b>Prime requisites</b>: An elf with at least 13 INT and STR gains a 5% bonus to experience. An elf with an INT of at least 16 and a STR of at least 13 receives a +10% XP bonus.`,
      ...
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.iH341o9KMs0jx96z]{Elf}<br>`,
      maxLvl: 10,
      nameType: 'elf'
    },
    fighter: {
    ...
    <b>Languages</b>: Alignment, Common<br>`,
      ...
      languages: ['Alignment', 'Common'],
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.tuxYnX5oQOhSkHrp]{Fighter}<br>`,
      maxLvl: 14,
      nameType: 'human'
    },
    halfling: {
    ...
    <b>Languages</b>: Alignment, Common, Halfling<br>`,
      ...
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.56pppv5spL3hnIbc]{Halfling}<br>`,
      maxLvl: 8,
      nameType: 'halfling'
    },
    'magic-user': {
    ...
    <b>Languages</b>: Alignment, Common<br>`,
      ...
      languages: ['Alignment', 'Common'],
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.8xWQ2MGa2LPMA43Z]{Magic-User}<br>`,
      maxLvl: 14,
      nameType: 'human'
    },
    thief: {
    ...
    Adjust ability scores: In step 3 of character creation, thieves may not lower STR.`,
      languages: ['Alignment', 'Common'],
      journal: `<br><br><b>Journal Entry</b>: @Compendium[${OSECB.moduleName}.OSE-SRD-classes.aTfwtSoLj0EYkOR7]{Thief}<br>`,
      maxLvl: 14,
      nameType: 'human'
    }
  };
